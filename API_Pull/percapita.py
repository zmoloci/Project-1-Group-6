...
for year in dates_list:
    url_data = "https://api.stlouisfed.org/geofred/regional/data?api_key=d6c9f833698c931c8e63dd3973b55579&series_group=882&date={0}&region_type=state&units=Dollars&frequency=a&season=NSA&file_type=json".format(year)
